...
class FindByMatriculaAlunoTest extends SpringAlunoControllerTestBase{
    ...
    void findByMatriculaAluno_ok() throws Exception {
        ...
        MvcResult mvcResult = new UtilTest().findBy_get200(mockMvc,urlBase+"/matricula/{matriculaAluno}",matricula);
    ...
    @Test
    @DisplayName("findByMatriculaAluno_nao_encontrado_erro, deve retornar uma exception do tipo FindAlunoException e status 404")
    void findByMatriculaAluno_nao_encontrado_erro() throws Exception {
        ...
        MvcResult mvcResult =new UtilTest().findBy_get404(mockMvc,urlBase+"/matricula/{matriculaAluno}",matricula);
        try {
